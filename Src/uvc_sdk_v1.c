...
LEP_RESULT UVC_GetAttribute(uvc_device_handle_t *devh,
...
LEP_RESULT UVC_SetAttribute(uvc_device_handle_t *devh,
                            LEP_COMMAND_ID commandID,
                            LEP_ATTRIBUTE_T_PTR attributePtr,
                            LEP_UINT16 attributeWordLength)
{
...
LEP_RESULT UVC_RunCommand(uvc_device_handle_t *devh,
                          LEP_COMMAND_ID commandID)
{
    int unit_id;
    int control_id;
